...
<div class="container">
  <form class="form-horizontal" role="form">
        ...
        <fieldset>
          ...
          <!-- Form Name -->
          <legend>Alta de Ususarios</legend>
          ...
          <!-- Text input-->
          <div class="form-group">
            <label class="col-sm-2 control-label" for="textinput">Confirmar</label>
            <div class="col-sm-4">
              <input type="password" placeholder="Confirmar" id="confirmar" class="form-control">
            </div>
